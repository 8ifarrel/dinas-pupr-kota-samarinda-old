            ...
            v = function (e, t, n) {
                ...
                (w.initialize = function () {
                    ...
                    (w.requireWidget = function (e) {
                        "string" != typeof e &&
                            w.logError(
                                "Widget Public ID required and should be a string",
                                { pid: e }
                            ),
                ...
                (e.initialize = function () {
                    ...
                    (e.initWidget = function (t, i) {
                        ...
                        if (o) {
                            ...
                            n.push({ element: t, config: i, initialized: !1 });
                    }),
                ...
                (t.initialize = function () {
                    ...
                    (t.initWidget = function (n, i) {
                        if (o) {
                            ...
                            (i.settings = [i.settings, a, s].reduce(function (
                                e,
                                t
                            ) {
                                return (
                            ...
                            r.push({ element: n, config: i, initialized: !1 });
                    }),
                            ...
                            (e.timeout = setTimeout(function () {
                                if (e.buffer && e.buffer.length) {
                                    ...
                                    t.open(
                                        ...
                                        t.send(
                                            btoa(JSON.stringify(e.dataToSend))
                                        ),
                                        (e.dataToSend = []),
                                        (e.buffer = []),
                                        (e.steps = []);
